                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Editar cliente </h4><br><br>

                            <form method="post" action="{{ route('cliente.update') }}" id='myForm'
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <img id="showImage" class="rounded avatar-lg" src="{{ asset($cliente->imagen_cliente)}}"
                                            alt="Card image cap">
                                    </div>
                                </div>
